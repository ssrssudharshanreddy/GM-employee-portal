      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-card p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/ws/orders" className="text-xs text-brand-600 hover:underline">View all</Link>
          </div>
          {orders.length === 0 ? (
            ...
            <div className="space-y-3">
              {orders.map((order) => (
                <Link key={order.id} href={`/ws/orders/${order.id}`} className="block p-4 bg-surface-50 hover:bg-surface-100 rounded-lg transition-colors">
        ...
        <div className="bg-white rounded-lg shadow-card p-5">
          ...
          <div className="space-y-3">
            <Link href="/ws/orders" className="flex items-center gap-3 p-4 bg-brand-50 hover:bg-brand-100 rounded-lg transition-colors">
            ...
            <Link href="/ws/returns" className="flex items-center gap-3 p-4 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors">
